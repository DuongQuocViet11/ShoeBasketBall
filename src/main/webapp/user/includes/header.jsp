      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-4">
          <div class="header-top-left">
            <ul class="phone-wrap">
              <li><span>Hotline :</span><a href="/home">(+84) 941077550</a></li>
            </ul>
          </div>
        </div>
            ...
            <ul class="ht-menu">
              ...
              <li>
                ...
                <div class="language ht-language">
                  <ul class="ht-setting-list">
                    <li class="active"><a href="#"><img src="/user/images/menu/flag-icon/1.jpg" alt="">English</a></li>
                    <li><a href="#"><img src="/user/images/menu/flag-icon/2.jpg" alt="">Français</a></li>
                  </ul>
                </div>
              </li>
      ...
      <div class="row">
        ...
        <div class="col-lg-3">
          <div class="logo pb-sm-30 pb-xs-30">
            <a href="/home">
              <img src="/user/images/menu/logo/1.jpg" alt="">
            </a>
          </div>
        </div>
                  ...
                  <ul class="minicart-product-list">
                    <li>
                      <a href="single-product.html" class="minicart-product-image">
                        <img src="/user/images/product/small-size/3.jpg" alt="cart products">
                      </a>
                    ...
                    <li>
                      <a href="single-product.html" class="minicart-product-image">
                        <img src="/user/images/product/small-size/4.jpg" alt="cart products">
                      </a>
                      <div class="minicart-product-details">
                        <h6><a href="single-product.html">Aenean eu tristique</a></h6>
                        <span>£80 x 1</span>
            ...
            <nav>
              <ul>
                ...
                <li class="hb-info f-right p-0 d-sm-none d-lg-block">
                  <span>46 De Tran Khat Chan, Hai Ba Trung, Ha Noi</span>
                </li>
