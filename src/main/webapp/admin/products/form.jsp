...
<%@ page import="com.shoebasketball.shoebasketball.entity.Category" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.ArrayList" %>
<%@ page import="com.shoebasketball.shoebasketball.entity.myenum.ProductStatus" %><%--
                ...
                <form action="<%=url%>" method="post" name="product-form">
                  <div class="row">
                    <div class="col-sm-3">
                      ...
                      <div class="form-group">
                        <label>Name</label>
                        <input type="text" name="name" value="<%=obj.getName()%>" class="form-control" placeholder="Please enter product name">
                  ...
                  <div class="row">
                    <div class="col-sm-4">
                      <!-- select -->
                      <div class="form-group">
                        <label>Please choose categories option</label>
